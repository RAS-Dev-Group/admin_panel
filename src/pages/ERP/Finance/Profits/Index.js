...
const getYearsList = (currentYear) => {
  let years = [];
  let j = 0;
  for(let i = currentYear - 10 ; i <= currentYear + 10; i++, j++)
    years[0] = i;
  ...
  return (
    <>
      <div className="page-header">
        ...
        <div className="page-tools text-right">
      ...
      <div className="page-content">
        <div className="page-section">
          <div className="chart-container-1">
            <div className="text-right"><select style={{ borderColor:'#82567A' }}><option>2005-2011</option></select></div>
            <Chart height={'500'} series={barchart.series} options={barchart.options} type='bar' />
            <div className="text-center chart-container-1-title">2005-2011 Yearly Expenses</div>
          </div>
        </div>
        <div>
          <select className="calendar-select" value={selectedMonth} onChange={handleMonthChange}>
          ...
          <select className="calendar-select" value={selectedYear} onChange={handleYearChange}>
